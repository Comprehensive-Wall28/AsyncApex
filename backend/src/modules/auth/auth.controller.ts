...
export class AuthController {
  ...
  @ApiResponse({ status: 400, description: 'Email already in use or validation error' })
  ...
  @ApiOperation({
    summary: 'Sign out',
    description: 'Invalidates the Cognito session globally. Optionally pass the Bearer token to revoke it server-side.',
  })
