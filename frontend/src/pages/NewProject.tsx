...
export const NewProject: React.FC = () => {
    ...
    return (
        ...
        <Box sx={{ display: 'flex', minHeight: '100vh', background: '#06060F', position: 'relative', overflow: 'hidden' }}>
            ...
            <Box sx={{
                position: 'fixed', bottom: '-15%', left: '20%', width: 500, height: 500,
            ...
            >
                <Box sx={{ maxWidth: 820, mx: 'auto', mt: 8, px: { xs: 2, md: 4 } }}>
                    {/* Back navigation */}
                    <Box sx={{ mb: 4 }}>
                        <IconButton
                    ...
                    <Box sx={glassCard}>
                        <Stack spacing={4}>
                            ...
                            <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', sm: '1fr 1fr' }, gap: 3 }}>
                                <TextField
                                    fullWidth
                                    label="Budget (TO BE DISCUSSED WITH BACKEND TEAM)"
                                    type="number"
                                    value={budget}
                                ...
                                <TextField
                                    fullWidth
                                    label="End Date (TO BE DISCUSSED WITH BACKEND TEAM)"
                                    type="date"
                                    value={endDate}
